...
import com.android.n05e.contacts.ContactLoader;
import com.android.n05e.contacts.ContactSaveService;
import com.android.n05e.contacts.ContactsActivity;
import com.android.n05e.contacts.ContactsUtils;
import com.android.n05e.contacts.R;
import com.android.n05e.contacts.activities.ActionBarAdapter.TabState;
import com.android.n05e.contacts.detail.ContactDetailFragment;
import com.android.n05e.contacts.detail.ContactDetailLayoutController;
import com.android.n05e.contacts.detail.ContactDetailUpdatesFragment;
import com.android.n05e.contacts.detail.ContactLoaderFragment;
import com.android.n05e.contacts.detail.ContactLoaderFragment.ContactLoaderFragmentListener;
import com.android.n05e.contacts.dialog.ClearFrequentsDialog;
import com.android.n05e.contacts.group.GroupBrowseListFragment;
import com.android.n05e.contacts.group.GroupBrowseListFragment.OnGroupBrowserActionListener;
import com.android.n05e.contacts.group.GroupDetailFragment;
import com.android.n05e.contacts.interactions.ContactDeletionInteraction;
import com.android.n05e.contacts.interactions.ImportExportDialogFragment;
import com.android.n05e.contacts.interactions.PhoneNumberInteraction;
import com.android.n05e.contacts.list.ContactBrowseListFragment;
import com.android.n05e.contacts.list.ContactEntryListFragment;
import com.android.n05e.contacts.list.ContactListFilter;
import com.android.n05e.contacts.list.ContactListFilterController;
import com.android.n05e.contacts.list.ContactTileAdapter.DisplayType;
import com.android.n05e.contacts.list.ContactTileFrequentFragment;
import com.android.n05e.contacts.list.ContactTileListFragment;
import com.android.n05e.contacts.list.ContactsIntentResolver;
import com.android.n05e.contacts.list.ContactsRequest;
import com.android.n05e.contacts.list.ContactsUnavailableFragment;
import com.android.n05e.contacts.list.DefaultContactBrowseListFragment;
import com.android.n05e.contacts.list.DirectoryListLoader;
import com.android.n05e.contacts.list.OnContactBrowserActionListener;
import com.android.n05e.contacts.list.OnContactsUnavailableActionListener;
import com.android.n05e.contacts.list.ProviderStatusWatcher;
import com.android.n05e.contacts.list.ProviderStatusWatcher.ProviderStatusListener;
import com.android.n05e.contacts.model.AccountWithDataSet;
import com.android.n05e.contacts.preference.ContactsPreferenceActivity;
import com.android.n05e.contacts.preference.DisplayOptionsPreferenceFragment;
import com.android.n05e.contacts.util.AccountFilterUtil;
import com.android.n05e.contacts.util.AccountPromptUtils;
import com.android.n05e.contacts.util.Constants;
import com.android.n05e.contacts.util.DialogManager;
import com.android.n05e.contacts.util.HelpUtils;
import com.android.n05e.contacts.util.PhoneCapabilityTester;
import com.android.n05e.contacts.util.UriUtils;
import com.android.n05e.contacts.widget.TransitionAnimationView;
