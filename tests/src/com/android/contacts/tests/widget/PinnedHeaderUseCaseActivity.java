...
package com.android.n05e.contacts.tests.widget;

import com.android.n05e.contacts.tests.R;
import com.android.n05e.contacts.widget.PinnedHeaderListView;
...
public class PinnedHeaderUseCaseActivity extends ListActivity {
    ...
    private void startActivity(int[] counts, String[] names, boolean[] headers,
        ...
        intent.setComponent(new ComponentName("com.android.n05e.contacts",
                "com.android.n05e.contacts.widget.PinnedHeaderListDemoActivity"));
